...
$(function () {
  ...
  var onCommunityAlbums = function onCommunityAlbums(event) {
    event.preventDefault();
    api.communityIndex().then(ui.onCommunityAlbumSuccess).catch(ui.onError);
  };
  ...
  var onUpdateAlbum = function onUpdateAlbum(event) {
    ...
    api.update(data).then(ui.onUpdateSuccess).catch(ui.onError);
    // } else {
  ...
  var onDeleteAlbum = function onDeleteAlbum(event) {
    ...
    api.destroy(data).then(ui.onDeleteSuccess).catch(ui.onError);
  };

  var onPostAlbum = function onPostAlbum(event) {
    event.preventDefault();
    var data = getFormFields(event.target);
    // console.log(data)

    api.post(data).then(ui.onPostSuccess).catch(ui.onError);
  };
  ...
  var onPostReview = function onPostReview(event) {
    ...
    api.postReview(data).then(ui.onPostReviewSuccess).catch(ui.onError);
  };

  var onGetMyAlbums = function onGetMyAlbums(event) {
    event.preventDefault();
    api.collect().then(ui.onGetMyAlbumSucess).catch(ui.onError);
  };
  ...
  var editAlbums = function editAlbums() {
  ...
  var postSection = function postSection() {
  ...
  var changePasswordSection = function changePasswordSection() {
...
var communityIndex = function communityIndex() {
  return $.ajax({
...
var indexOwners = function indexOwners() {
  return $.ajax({
    url: config.apiUrl + '/discs',
    method: 'GET'
  });
...
var apiUrl = void 0;
var apiUrls = {
  production: ' https://morning-coast-76185.herokuapp.com',
...
var onPostReviewSuccess = function onPostReviewSuccess(data) {
...
var onCommunityAlbumSuccess = function onCommunityAlbumSuccess(data) {
...
var onGetMyAlbumSucess = function onGetMyAlbumSucess(data) {
...
module.exports = {
  ...
  onGetMyAlbumSucess: onGetMyAlbumSucess,
  onCommunityAlbumSuccess: onCommunityAlbumSuccess,
  onPostReviewSuccess: onPostReviewSuccess,
